...
public class Gift extends AbstractEntity {
    ...
    public Gift(
        ...
        if (StringUtils.isEmpty(giftReceiverName))
            throw new InvalidParamException("Gift constructor giftReceiverName is empty");
        if (StringUtils.isEmpty(giftReceiverPhone))
            throw new InvalidParamException("Gift constructor giftReceiverPhone is empty");
    ...
    public void accept(GiftCommand.Accept request) {
        ...
        if (StringUtils.isEmpty(receiverAddress1))
            throw new InvalidParamException("Gift accept receiverAddress1 is empty");
        if (StringUtils.isEmpty(receiverAddress2))
            throw new InvalidParamException("Gift accept receiverAddress2 is empty");
